...
type UserAPIStruct struct {
	...
	Internal struct {
		...
		CreateAssetGroup func(p0 context.Context, p1 int, p2 string, p3 string) (*types.AssetGroup, error) `perm:"user,web,admin"`

		DeleteAPIKey func(p0 context.Context, p1 string, p2 string) (error) `perm:"web,admin"`

		DeleteAssetGroup func(p0 context.Context, p1 int, p2 string) (error) `perm:"user,web,admin"`
		...
		ListAssetGroup func(p0 context.Context, p1 int, p2 string, p3 int, p4 int) (*types.ListAssetGroupRsp, error) `perm:"user,web,admin"`

		ListAssetSummary func(p0 context.Context, p1 int, p2 string, p3 int, p4 int) (*types.ListAssetSummaryRsp, error) `perm:"user,web,admin"`
...
func (s *UserAPIStruct) CreateAssetGroup(p0 context.Context, p1 int, p2 string, p3 string) (*types.AssetGroup, error) {
...
func (s *UserAPIStub) CreateAssetGroup(p0 context.Context, p1 int, p2 string, p3 string) (*types.AssetGroup, error) {
	return nil, ErrNotSupported
}
...
func (s *UserAPIStruct) DeleteAssetGroup(p0 context.Context, p1 int, p2 string) (error) {
...
func (s *UserAPIStub) DeleteAssetGroup(p0 context.Context, p1 int, p2 string) (error) {
	return ErrNotSupported
}
...
func (s *UserAPIStruct) ListAssetGroup(p0 context.Context, p1 int, p2 string, p3 int, p4 int) (*types.ListAssetGroupRsp, error) {
...
func (s *UserAPIStub) ListAssetGroup(p0 context.Context, p1 int, p2 string, p3 int, p4 int) (*types.ListAssetGroupRsp, error) {
	return nil, ErrNotSupported
}

func (s *UserAPIStruct) ListAssetSummary(p0 context.Context, p1 int, p2 string, p3 int, p4 int) (*types.ListAssetSummaryRsp, error) {
...
func (s *UserAPIStub) ListAssetSummary(p0 context.Context, p1 int, p2 string, p3 int, p4 int) (*types.ListAssetSummaryRsp, error) {
	return nil, ErrNotSupported
}
...
func (s *UserAPIStub) MoveAssetToGroup(p0 context.Context, p1 string, p2 int, p3 string) (error) {
	return ErrNotSupported
}
